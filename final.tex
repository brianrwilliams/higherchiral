...
When $d=2$, a two-dimensional space of central extensions of $\mathfrak{witt}_2^\bu$ is studied in \cite{bwac}; the resulting algebras
...
$$
\rho_{vir}\colon \mathfrak{witt}^{\bullet}_{2}\rightarrow h^{Lie}(\mathcal{F}):=(h\boxtimes 1)\left(\mathbf{J}^{2,\bullet}_{\mathbb{A}^d}(\mathcal{F}\boxtimes \mathcal{O})\right)
$$
defined by
$$
...
$$
\gamma_{vir}\colon \wedge^3 \mathfrak{witt}^{\bullet}_{2}\rightarrow \mathbb{C}
$$
by the formula
$$
...
\begin{rem}
This result is compatible with a local universal index theorem in the spirit of \cite{Beilinson:1986zw}.
  Indeed, up to an overall factor, this central extension corresponds to the degree six part of the universal Todd class
  $\op{Td}_6 = \frac{1}{24} c_1 c_2 = \frac{1}{24} (c_1^3 - c_1 \op{ch}_2)$, where $\op{ch}_2$ is the second component
  of the universal Chern character. 
\end{rem}
\begin{figure}[htbp]
    \centering
...
\end{tikzpicture}
  ...
  \caption{}\label{}
\end{figure}
Now, we start from the expression
 \begin{align*}
...
\end{align*}
  Here, we have defined the loop momentum $\mathfrak{z}_{[21o]} = \mathfrak{z}_{21} - \mathfrak{z}_{2o} - \mathfrak{z}
  _{1o}$, for example.
\begin{align*}
