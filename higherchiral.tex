...
\begin{figure}[ht]
  ...
  \begin{tikzpicture}[
    ...
    >={Straight Barb[scale=1.2]},  % arrow style
    shorten >=2pt,
    shorten <=2pt,
    node distance=3cm
  ]
  ...
  % Arrows: two parallel arrows from A to B
...
\end{figure}
        ...
        Let's compute $\mu^{\mathbf{\omega}}_{\{1,2\}}(p_{(\vec{\Gamma},m_{1},2)}d^{2}z_{1}\boxtimes d^{2}z_{2})$. By proposition \ref{explicit formula}, we have
        \begin{align*}
            &\mu^{\omega}_{\{1,2\}}(p_{(\vec{\Gamma},m_{1},2)}d^{2}z_{1}\boxtimes d^{2}z_{2})\\
        ...
        Similarly, we have
        \begin{align*}
            &\mu^{\omega}_{\{1,2\}}(-p_{(\vec{\Gamma},m_{2},2)}d^{2}z_{1}\boxtimes d^{2}z_{2})\\
            &=
        ...
        \begin{align*}
            &\mu^{\omega}_{\{1,2\}}(P_{12}d^{2}z_{1}\boxtimes d^{2}z_{2})\\
            &=
